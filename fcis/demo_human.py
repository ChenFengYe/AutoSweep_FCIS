...
test_dir = './demo/Human/test_temp/'
result_dir = './demo/Human/result_temp/'
model_dir = './model/fcis_Human_e2e'
yaml_dir = './experiments/fcis/cfgs/fcis_Human_demo.yaml'
...
update_config(cur_path + '/../' + yaml_dir)
...
def main():
    ...
    for im_name in image_names:
        assert os.path.exists(cur_path + '/../' + test_dir + im_name), ('%s does not exist'.format('../demo/' + im_name))
    ...
    arg_params, aux_params = load_param(cur_path + '/../' + model_dir, 0, process=True)
    ...
    for idx, im_name in enumerate(image_names):
        ...
        # Save img
        cv2.imwrite(cur_path + '/../'+ result_dir + im_name, cv2.cvtColor(im,cv2.COLOR_BGR2RGB))
