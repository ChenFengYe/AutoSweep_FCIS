...
# test_dir = './data/ObjectSnap/6000/img/'
# test_dir = './demo/test/'
test_dir = './data/ObjectSnap/Refine/img/'
label_dir = './data/ObjectSnap/Refine/seg/'
# result_dir = './demo/2017.8.6_geonet_training_data_color/'
# result_dir = './demo/result/'
result_dir = './demo/12342_mask_2/'
update_config(cur_path + '/../experiments/fcis/cfgs/resnet_v1_101_ObjectSnap_fcis_end2end_ohem.yaml')
...
def main():
    ...
    for idx, im_name in enumerate(image_names[9001:len(image_names)]):
        ...
        ims = show_masks(im, dets, masks, classes, config, 1.0 / scales[0], False)
