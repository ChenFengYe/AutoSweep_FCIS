...
class ObjectSnap(IMDB):
    def __init__(self, image_set, root_path, devkit_path, result_path=None, mask_size=-1, binary_thresh=None):
        ...
        super(ObjectSnap, self).__init__('voc_' + year, image_set, root_path, devkit_path, result_path)  # set self.name

        self.year = year
        self.root_path = root_path
        self.devkit_path = devkit_path
        self.data_path = os.path.join(devkit_path, year)
        # 6classes
        ...
        # 5classes
        self.classes = ['__background__',  # always index 0
                        'CubeBody', 'CubeFace', 'CylinderBody', 'CylinderFace']
